  ...
  return (
    <div>
      ...
      <div className="h-[600px] flex flex-col justify-center items-center ">
        <div className="max-w-96 md:w-auto p-10 border shadow-slate-500">
          ...
          <button
            ...
            type="button"
            className="flex items-center justify-center w-full p-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-600 focus:ring-violet-600"
          >
            <svg
